const tokens = {
  ...
  "colors.primary.alpha": {
    "value": "rgba(1, 52, 94, 0.5)",
    "variable": "var(--colors-primary-alpha)"
  },
  "colors.secondary.50": {
    "value": "#e6f1f9",
  ...
  "colors.secondary.alpha": {
    "value": "rgba(2, 115, 191, 0.5)",
    "variable": "var(--colors-secondary-alpha)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.colorPalette.alpha": {
    "value": "var(--colors-color-palette-alpha)",
    "variable": "var(--colors-color-palette-alpha)"
  }
}
